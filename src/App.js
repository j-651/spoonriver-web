...
function App() {
  let data = {
    ...
    "links": [
      ...
      { "source": "Isa Nutter", "target": "Doc Myers", "value": 1 },
      ...
      { "source": "Penniwit, the Artist", "target": "Judge Somers", "value": 1 },
      ...
      { "source": "Elsa Wertman", "target": "Hamilton Greene", "value": 1 },
      { "source": "Hamilton Greene", "target": "Elsa Wertman", "value": 1 },
      { "source": "Ernest Hyde", "target": "Roger Heston", "value": 1 },
